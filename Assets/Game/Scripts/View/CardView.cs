...
namespace Game.Scripts.View
{
    ...
    public partial class CardViewMvvm
    {
        ...
        public AsakiProperty<int> CardCost { get; private set; } = new();

        [field: SerializeField]
        public AsakiProperty<int> CardAtk { get; private set; } = new();

        [field: SerializeField]
        public AsakiProperty<int> CardDef { get; private set; } = new();
    }
    ...
    public class CardView : MonoBehaviour, IAsakiPoolable, IAsakiInit<IAsakiResourceService>
    {
        ...
        [SerializeField]
        private TMP_Text CardAtkText;

        [SerializeField]
        private TMP_Text CardDefText;
        ...
        public async UniTask LoadCardData(CardData cardData)
        {
            ...
            CardSprite.sprite = await _asakiResourceService.LoadAsync<Sprite>(
                cardData.CardSpriteAssetKey,
