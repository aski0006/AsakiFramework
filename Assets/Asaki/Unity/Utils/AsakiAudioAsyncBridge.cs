    ...
    internal static class AsakiAudioAsyncBridge
    {
        ...
        )
        {
            ...
            return new Awaitable(
                UniTask.Delay(millisecondsDelay, ignoreTimeScale, PlayerLoopTiming.Update, token)
            );
#else
        ...
        private static async UniTaskVoid ForgetWithCustomHandler(
            UniTask task,
